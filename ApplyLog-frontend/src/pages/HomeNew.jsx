...
export default function Home() {
  ...
  return (
    <div className="min-h-screen ml-64 p-8 space-y-8">
      {/* Header */}
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-4xl font-bold text-white mb-2">Your Application Dashboard</h1>
          <p className="text-gray-400">Track your job search progress and stay organized</p>
        </div>
